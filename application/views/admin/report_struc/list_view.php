<table class="table table-hover">
	...
	<?php
		foreach ($chief_ls as $post_row) {
			...
			echo anchor('admin/post/edit_attr/', '</i><i class="fa fa-pencil"></i> ', 'class="btn btn-act-2" data-obj="'.$post_row->post_id.'" title="'.lang('act_edit').' '. lang('om_post').'" data-fancybox-type="ajax"');
